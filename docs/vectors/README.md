...
| `body.json` | the padded encoding of each body kind, a copy for a second device naming its message's id, a device revocation, and the everyday kinds of section 4.7 (a reply, an edit, a deletion, a reaction given and withdrawn, a timer) among them |
